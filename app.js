...
var conversation = watson.conversation({
    ...
    username: '3d6a00ff-0ca6-4e1b-b206-2f300abbf1fd',   // Set to your conversation username
    password: 'TlPqiWuN7Npf',   // Set to your conversation password
...
app.post('/api/bot', function(req, res) {
    ...
    var workspace = 'a4b8ee20-6bd5-4e64-b3b9-dc60352ccce7'; // Set to your Conversation workspace ID
